...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run() {
        String[] text = new String[]{ "Four Season Hotel", "Baglioni Hotel", "Taj Exotica Resort", "Sky View", "Royal Palace", "JW Marriott Hotel", "Como Cocoa Island", "Majestic Manor Retreat", "Elite Enclave Resort", "Silk Serenity Suites" };
        try {
            for (int i = 0 ; i <= 9 ; i++) {
    ...
    CheckHotels() {
        ...
        caption.setBackground(new Color(133, 193, 233));
